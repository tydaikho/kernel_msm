...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  850000, 950000,  1 },
	[1]  = { {  486000, HFPLL, 2, 0x10 },  950000, 950000,  2 },
	[2]  = { {  540000, HFPLL, 2, 0x14 },  950000, 950000,  2 },
	[3]  = { {  594000, HFPLL, 1, 0x16 },  950000, 950000,  2 },
	[4]  = { {  648000, HFPLL, 1, 0x18 },  950000, 950000,  4 },
	[5]  = { {  702000, HFPLL, 1, 0x1A }, 1050000, 1050000, 4 },
	[6]  = { {  756000, HFPLL, 1, 0x1C }, 1050000, 1050000, 4 },
	[7]  = { {  810000, HFPLL, 1, 0x1E }, 1050000, 1050000, 4 },
	[8] = { {  864000, HFPLL, 1, 0x20 }, 1050000, 1050000, 4 },
	[9] = { {  918000, HFPLL, 1, 0x22 }, 1050000, 1050000, 5 },
	[10] = { {  972000, HFPLL, 1, 0x24 }, 1050000, 1050000, 5 },
	[11] = { { 1026000, HFPLL, 1, 0x26 }, 1050000, 1050000, 5 },
	[12] = { { 1080000, HFPLL, 1, 0x28 }, 1050000, 1050000, 5 },
	[13] = { { 1134000, HFPLL, 1, 0x2A }, 1050000, 1050000, 5 },
	[14] = { { 1188000, HFPLL, 1, 0x2C }, 1050000, 1050000, 5 },
	{ }
};
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 1, {  1350000, HFPLL, 1, 0x30 }, L2(14), 1175000 },
	{ 1, {  1512000, HFPLL, 1, 0x34 }, L2(14), 1200000 },
	{ 0, { 0 } }
};
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	...
	{ 1, {  1350000, HFPLL, 1, 0x30 }, L2(14), 1125000 },
	{ 1, {  1512000, HFPLL, 1, 0x34 }, L2(14), 1150000 },
	{ 1, {  1620000, HFPLL, 1, 0x3E }, L2(14), 1255000 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	...
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(14), 1050000 },
	{ 1, {  1350000, HFPLL, 1, 0x30 }, L2(14), 1075000 },
	{ 1, {  1512000, HFPLL, 1, 0x34 }, L2(14), 1100000 },
	{ 1, {  1620000, HFPLL, 1, 0x3E }, L2(14), 1205000 },
...
static struct acpu_level acpu_freq_tbl_faster[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),  775000 },
        ...
        { 1, {  1350000, HFPLL, 1, 0x30 }, L2(14), 1075000 },
        { 1, {  1512000, HFPLL, 1, 0x34 }, L2(14), 1100000 },
	{ 1, {  1620000, HFPLL, 1, 0x3E }, L2(14), 1155000 },
